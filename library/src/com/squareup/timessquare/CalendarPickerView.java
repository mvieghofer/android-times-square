...
public class CalendarPickerView extends ListView {
    public enum SelectionMode {
         ...
         * <ul>
         * <li>Have a range selected and select another date (even if it's in the current range).
         * </li>
    ...
    /**
     * Both date parameters must be non-null and their {@link Date#getTime()} must not return 0.
     * Time
     * of day will be ignored.  For instance, if you pass in {@code minDate} as 11/16/2012 5:15pm
     * and
    ...
    public class FluentInitializer {
        ...
        public FluentInitializer withSelectedDates(Collection<Date> selectedDates) {
            if (selectionMode == SelectionMode.SINGLE && selectedDates.size() > 1) {
                throw new IllegalArgumentException("SINGLE mode can't be used with "
    ...
    List<List<MonthCellDescriptor>> getMonthCells(MonthDescriptor month, Calendar startCal) {
        ...
        while ((cal.get(MONTH) < month.getMonth() + 1 || cal.get(YEAR) < month.getYear()) //
            ...
            for (int c = 0; c < 7; c++) {
                ...
                weekCells.add(
                        new MonthCellDescriptor(date, isCurrentMonth, isSelectable, isSelected,
    ...
    private class DefaultOnInvalidDateSelectedListener implements OnInvalidDateSelectedListener {
        ...
        public void onInvalidDateSelected(Date date) {
            String errMessage =
                    getResources().getString(R.string.invalid_date, fullDateFormat.format(
                                    minCal.getTime()),
